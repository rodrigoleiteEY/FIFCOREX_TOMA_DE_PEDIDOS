package com.company.fifcorex_toma_de_pedidos.viewmodel.ordersitem
...
/*
 * Represents View model for OrdersItem
 *
 ...
 */
class OrdersItemViewModel(application: Application): EntityViewModel<OrdersItem>(application, EntitySets.ordersItem, OrdersItem.productCode) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<OrdersItem>(application, EntitySets.ordersItem, OrdersItem.productCode, navigationPropertyName, entityData)
    }
}

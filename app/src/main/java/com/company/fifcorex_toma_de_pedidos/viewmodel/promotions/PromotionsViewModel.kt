package com.company.fifcorex_toma_de_pedidos.viewmodel.promotions
...
/*
 * Represents View model for Promotions
 *
 ...
 */
class PromotionsViewModel(application: Application): EntityViewModel<Promotions>(application, EntitySets.promotions, Promotions.grupoMaterial) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<Promotions>(application, EntitySets.promotions, Promotions.grupoMaterial, navigationPropertyName, entityData)
    }
}

package com.company.fifcorex_toma_de_pedidos.viewmodel.credit
...
/*
 * Represents View model for Credit
 *
 ...
 */
class CreditViewModel(application: Application): EntityViewModel<Credit>(application, EntitySets.credit, Credit.total) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<Credit>(application, EntitySets.credit, Credit.total, navigationPropertyName, entityData)
    }
}
